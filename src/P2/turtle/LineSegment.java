...
public class LineSegment {
    ...
    private final P2.turtle.PenColor color;
     ...
     */
    public LineSegment(double startx, double starty, double endx, double endy, P2.turtle.PenColor color) {
     ...
     * @param color line segment color
     */
    public LineSegment(Point start, Point end, P2.turtle.PenColor color) {
        this.start = start;
        this.end = end;
        this.color = color;
    }
