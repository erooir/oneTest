...
public class Action {
    ...
    private final P2.turtle.LineSegment lineSegment;
     ...
     */
    public Action(ActionType type, String displayString, P2.turtle.LineSegment lineSeg) {
        this.type = type;
     ...
     */
    public P2.turtle.LineSegment lineSegment() {
        return lineSegment;
    }
}
